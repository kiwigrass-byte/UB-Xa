...
- In my experience, the preset occasionally trips up while parsing the large sysEx dumps. Sometimes this can be fixed by manually triggering the requests again. However, sometimes I have to reboot the controller. I'm continuing to work on making things more stable.
